...
<script>
 function changesOnchange(){
	 ...
	 if(document.getElementById("relStatus").value=="It's complicated"){
		 hideFields();
		 document.getElementById('withLabel').style.visibility='visible';
		 document.getElementById('relWith').style.visibility='visible';
		 document.getElementById('sinceLabel').style.visibility='visible';
...
<div class="scroll3">
<form action="saveRelStatus">
  <s:select  label="Relationship Status" 
		 list="relStatusList" name="relStatusList" onchange="changesOnchange()" id="relStatus" >
