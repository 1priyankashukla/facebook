...
<div  class="second" ><tiles:insertAttribute name="navMenu" /></div>
<div class="third"><tiles:insertAttribute name="newsFeed" /></div>
<div class="fourth"><tiles:insertAttribute name="activityLog" /></div>
